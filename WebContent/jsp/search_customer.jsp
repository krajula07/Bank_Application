...
<title>Bank/search_customer</title>
...
<body>
	<div class="header">
		...
		<div class="executive-nav">
			<ul>
				<li><a class="nav-btn" href="<%=request.getContextPath() %>/jsp/excecutive_Home.jsp" ><i class="material-icons">home</i>Home</a></li>
				<li>
					<div class="dropdown">
		...
		<form action="">
			<table class="search_table" align="center">
							...
							<tr>
								<th>SSN ID</th>
								<td width=20px>:</td>
								<td><input type="text" name="ssn_id" id="ssn_id" placeholder="SSN ID"></td>
							</tr>
			</table>
