...
%>
		<form action="<%=request.getContextPath() %>/BankController">
			...
			<input type="hidden" name="address" id="address" value=<%=c.getAddress() %>>
			<input type="hidden" name="ssnId" id="ssnId" value=<%=c.getSSNID() %>>
			<input type="hidden" name="cus_id" id="cus_id" value=<%=c.getCustomerId() %>>
			<input type="hidden" name="cust_name" id="cust_name" value=<%=c.getName() %>>
			<input type="hidden" name="age" id="age" value=<%=c.getAge() %>>
			<input class="button" type="submit" name="status" value="Delete" onclick="return createCustomer();">
