...
<body>
	...
	<div class=create-content>
		...
		<%} %>
		<%-- <%
	String c=(String)request.getAttribute("customer");
		...
		<form action="<%=request.getContextPath() %>/BankController">
			...
			<!-- 	<tr>
				...
				<tr>
					<th>Customer ID<span class="mandatory_asterisk">*</span></th>
					<td width=20px>:</td>
					<td><%=session.getAttribute("customer") %></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" name="Amount" id="Amount" placeholder="Amount"></td>
						...
						<input type="hidden" name="cus_id" id="cus_id" value=<%=session.getAttribute("customer") %>>
			
			<input class="button" type="submit" name="status" value="CreateAccountExte" onclick="return create_account();">
